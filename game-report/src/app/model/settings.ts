...
export class Settings {
  ...
  public get storageKey() { return this._storageKey; }
  public get version() { return this._version; }

  public get dayInterval() { return this._dayInterval; }
  public set dayInterval(interval: number) {
  ...
  public get playGamedataName() { return this._playGamedataName; }
  public set playGamedataName(val: string) { this._playGamedataName = val; }
  set modifier(val: string) { this.dayModifier.modifier = val }
  get modifier() { return this.dayModifier.modifier }
  set cycleLength(val: number) { this.dayModifier.cycleLength = val }
  get cycleLength() { return this.dayModifier.cycleLength }
  setModifierUnit = (val: string, i: number) => { this.dayModifier.updateUnit(val, i) }

  getNextDay = (day: number): number => { return day + this.dayInterval; }
  getModifierDay = (day: number): string => { return this.dayModifier.modifyDay(day) }
}
