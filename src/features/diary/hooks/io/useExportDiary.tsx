...
import { IDiaryExporter } from '@features/diary/control/diary/controlDiaryInterface';

const useExportDiary = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      const { data, fileName } = await diaryExporter.exportFile();
